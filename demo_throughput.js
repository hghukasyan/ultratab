...
async function main() {
    ...
    console.log(`  Created ${(fileSize / 1024 / 1024).toFixed(2)} MB in ${Number(createEnd - createStart) / 1e6} ms\n`);
    ...
    console.log(`  ${csvResult.rows.toLocaleString()} rows in ${csvResult.ms.toFixed(1)} ms = ${csvRps} rows/sec\n`);
    ...
    console.log(`  ${colResult.rows.toLocaleString()} rows in ${colResult.ms.toFixed(1)} ms = ${colRps} rows/sec\n`);

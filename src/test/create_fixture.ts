...
function writeU16(b: Buffer, o: number, v: number): void {
  b[o] = v & 0xff;
  b[o + 1] = (v >> 8) & 0xff;
}

function writeU32(b: Buffer, o: number, v: number): void {
  b[o] = v & 0xff;
  b[o + 1] = (v >> 8) & 0xff;
  b[o + 2] = (v >> 16) & 0xff;
  b[o + 3] = (v >> 24) & 0xff;
...
const chunks: Buffer[] = [];
const centralRecords: { record: Buffer; offset: number }[] = [];
let offset = 0;
...
for (const [name, content] of entries) {
  ...
  let o = 0;
  writeU32(localHeader, o, LOCAL_HEADER_SIG); o += 4;
  writeU16(localHeader, o, 20); o += 2;
  writeU16(localHeader, o, 0); o += 2;
  writeU16(localHeader, o, 8); o += 2;
  writeU16(localHeader, o, 0); writeU16(localHeader, o + 2, 0); o += 4;
  writeU32(localHeader, o, 0); o += 4;
  writeU32(localHeader, o, compressed.length); o += 4;
  writeU32(localHeader, o, uncompressed.length); o += 4;
  writeU16(localHeader, o, nameBuf.length); o += 2;
  writeU16(localHeader, o, 0); o += 2;
  ...
  o = 0;
  writeU32(central, o, CENTRAL_SIG); o += 4;
  writeU16(central, o, 20); o += 2;
  writeU16(central, o, 20); o += 2;
  writeU16(central, o, 0); o += 2;
  writeU16(central, o, 8); o += 2;
  writeU16(central, o, 0); writeU16(central, o + 2, 0); o += 4;
  writeU32(central, o, crc32(uncompressed)); o += 4;
  writeU32(central, o, compressed.length); o += 4;
  writeU32(central, o, uncompressed.length); o += 4;
  writeU16(central, o, nameBuf.length); o += 2;
  writeU16(central, o, 0); o += 2;
  writeU16(central, o, 0); o += 2;
  writeU16(central, o, 0); o += 2;
  writeU32(central, o, 0); o += 4;
  writeU32(central, o, offset); o += 4;
...
let eo = 0;
writeU32(eocd, eo, EOCD_SIG); eo += 4;
writeU16(eocd, eo, 0); eo += 2;
writeU16(eocd, eo, 0); eo += 2;
writeU16(eocd, eo, entries.length); eo += 2;
writeU16(eocd, eo, entries.length); eo += 2;
writeU32(eocd, eo, centralSize); eo += 4;
writeU32(eocd, eo, centralStart); eo += 4;
writeU16(eocd, eo, 0); eo += 2;
